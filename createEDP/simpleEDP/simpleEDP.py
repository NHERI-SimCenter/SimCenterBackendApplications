...
def write_RV(BIM_input_path, EDP_input_path):
...
def create_EDP(BIM_input_path, EDP_input_path):
    pass   
...
if __name__ == '__main__':
    ...
    if args.getRV:
        sys.exit(write_RV(args.filenameBIM, args.filenameEDP))
    else:
        sys.exit(create_EDP(args.filenameBIM, args.filenameEDP))