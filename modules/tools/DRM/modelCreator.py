...
parser.add_argument('--soilwidth_x', type=float, help='width of the soil in x direction')
parser.add_argument('--soilwidth_y', type=float, help='width of the soil in y direction')
parser.add_argument('--soilwidth_z', type=float, help='width of the soil in z direction')
parser.add_argument('--soilNumEle_x', type=int, help='number of elements in x direction')
parser.add_argument('--soilNumEle_y', type=int, help='number of elements in y direction')
parser.add_argument('--soilNumEle_z', type=int, help='number of elements in z direction')
...
parser.add_argument('--DRM_CoordinateTransformation', type=bool, help='DRM coordinate transformation')
parser.add_argument('--Absorb_HaveAbsorbingElements', type=str, help='Absorbing elements')
parser.add_argument('--Absorb_NumAbsorbingElements', type=int, help='Number of absorbing elements')
...
if Target == "Soil-with-structure":
    copy_file(f"MeshGenerator/models/Soil_with_structure.tcl", f"{meshdir}/model.tcl")
