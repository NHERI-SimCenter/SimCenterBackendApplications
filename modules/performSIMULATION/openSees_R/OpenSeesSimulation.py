...
if ('-getRV' in inputArgs) or ('--getRV' in inputArgs):
    getUncertaintyCommand = '"{}/getUncertainty" {} {} {} {}'.format(
        scriptDir, bimName, samName, evtName, simName
    )
    subprocess.Popen(args=getUncertaintyCommand, shell=True).wait()
else:
    # Run preprocessor
    preprocessorCommand = '"{}/mainPreprocessor" {} {} {} {} example.tcl'.format(
        scriptDir, bimName, samName, evtName, edpName
    )
    ...
    # Run postprocessor
    postprocessorCommand = '"{}/mainPostprocessor" {} {} {} {}'.format(
        scriptDir, bimName, samName, evtName, edpName
    )
