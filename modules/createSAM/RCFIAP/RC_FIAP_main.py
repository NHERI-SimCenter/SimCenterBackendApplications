...
class DuctilityCurve:  # noqa: D101
    def __init__(self, xi, xe, yi, ye, CD_i, CD_e):  # noqa: ANN001, ANN204, N803
        self.xi = xi
        self.xe = xe
        self.yi = yi
        self.ye = ye
...
def runBuildingDesign(BIM_file, EVENT_file, SAM_file, getRV):  # noqa: ANN001, ANN201, ARG001, N802, N803, D103
    # Get the current directory
...
class RCFIAP:  # noqa: D101
    def Design(self, rootSIM):  # noqa: ANN001, ANN201, C901, D102, N802, N803, PLR0914, PLR0915
    ...
    def CreateNLM(self, rootSIM, outputLogger, preparePushover):  # noqa: ANN001, ANN201, C901, D102, N802, N803, PLR0914, PLR0915
        def __init__(rootSIM):  # noqa: ANN001, ANN202, N803, N807
            self.rootSIM = rootSIM
    ...
    # Pushover function
    def Pushover(self, rootSIM):  # noqa: ANN001, ANN201, C901, D102, N802, N803, PLR0914, PLR0915
        def __init__(rootSIM):  # noqa: ANN001, ANN202, N803, N807
            self.rootSIM = rootSIM

        global cbar  # noqa: PLW0602

        def singlePush1(dref, mu, ctrlNode, dispDir, nSteps):  # noqa: ANN001, ANN202, C901, N802, N803
            IOflag = 2  # noqa: N806
        ...
        def singlePush(dref, mu, ctrlNode, dispDir, nSteps):  # noqa: ANN001, ANN202, C901, N802, N803
            # --------------------------------------------------
