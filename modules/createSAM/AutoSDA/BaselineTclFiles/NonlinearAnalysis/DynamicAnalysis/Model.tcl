...
# set scalefactor [expr $g*$scale/100*$MCEScaleFactor]; # Stevan Gavrilovic commented out for EE-UQ implementation

# Run Time History
# source DefineTimeHistory.tcl # Stevan Gavrilovic commented out for EE-UQ implementation

# puts "Analysis Completed" # Stevan Gavrilovic commented out for EE-UQ implementation
