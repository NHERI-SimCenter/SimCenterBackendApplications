...
#     target_model = base_directory / 'BuildingNonlinearModels' / building_id / analysis_type  # noqa: ERA001, E501
#     # Change the working directory to that model folder
#     os.chdir(target_model)  # noqa: ERA001
#     # Display which model you are analyzing
#     print('Current model is: ', building_id)  # noqa: ERA001
#     # Run OpenSees.exe file
#     os.system('OpenSees Model.tcl')  # noqa: ERA001
