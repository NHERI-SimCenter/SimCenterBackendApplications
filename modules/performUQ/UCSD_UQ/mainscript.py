...
if __name__ == '__main__':
    ...
    # move cal data file
    os.rename(os.path.join(workdirTemplate, calDataFileName), os.path.join(workdirMain, calDataFileName))
    ...
    for modelNum, variables in enumerate(variablesList):
        ...
        mytrace = RunTMCMC(Np, AllPars, Nm_steps_max, Nm_steps_maxmax, logLikeModule.log_likelihood, variables,
                           ...
                           edpNamesList, edpLengthsList, scaleFactors, shiftFactors, runType, logFile,
                           MPI_size, workflowDriver, parallelizeMCMC)
        logFile.write('\n\n\t==========================')
