...
def main(args):  # noqa: ANN001, ANN201, D103, PLR0915
    ...
    if runType in [
        ...
        if (
            ...
            # natafExe = os.path.join('nataf_gsa','nataf_gsa')  # noqa: ERA001
            ...
            surrogate = 'surrogateBuild.py'
            plom = 'runPLoM.py'  # KZ: main script of PLoM
            # natafExe = os.path.join('nataf_gsa','nataf_gsa.exe')  # noqa: ERA001
        ...
        if uq_data['uqType'] == 'Train GP Surrogate Model':
            simCenterUQCommand = f'"{python}" "{myScriptDir}/{surrogate}" "{workdir_main}" {inputFile} {workflowDriver} {osType} {runType} 1> logFileSimUQ.txt 2>&1'  # noqa: N806, E501
        elif (
            uq_data['uqType'] == 'Sensitivity Analysis'
            or uq_data['uqType'] == 'Forward Propagation'
        ):
            simCenterUQCommand = f'"{myScriptDir}/{natafExe}" "{workdir_main}" {inputFile} {workflowDriver} {osType} {runType} 1> logFileSimUQ.txt 2>&1'  # noqa: N806, E501
        ...
        # if uq_data['uqType'] == 'Train GP Surrogate Model':
        #     simCenterUQCommand = '"{}" "{}/{}" "{}" {} {} {} {} 1> logFileSimUQ.txt 2> dakota.err2'.format(python,myScriptDir,surrogate,workdir_main,inputFile, workflowDriver, osType, runType)  # noqa: ERA001, E501
        # elif uq_data['uqType'] == 'Sensitivity Analysis':  # noqa: ERA001
        #     simCenterUQCommand = '"{}/{}" "{}" {} {} {} {} 1> logFileSimUQ.txt 2> dakota.err2'.format(myScriptDir,natafExe,workdir_main,inputFile, workflowDriver, osType, runType)  # noqa: ERA001, E501
        # elif uq_data['uqType'] == 'Forward Propagation':  # noqa: ERA001
        #     simCenterUQCommand = '"{}/{}" "{}" {} {} {} {} 1> logFileSimUQ.txt 2> dakota.err2'.format(myScriptDir,natafExe,workdir_main,inputFile, workflowDriver, osType, runType)  # noqa: ERA001, E501
        # # KZ: training calling runPLoM.py to launch the model training
        # elif uq_data['uqType'] == 'PLoM Model':  # noqa: ERA001
        #     simCenterUQCommand = '"{}" "{}" "{}" {} {} {} {} 1> logFileSimUQ.txt 2> dakota.err2'.format(python, os.path.join(myScriptDir,plom).replace('\\','/'),workdir_main.replace('\\','/'),inputFile,workflowDriver,osType,runType)  # noqa: ERA001, E501

        # if uq_data['uqType'] == 'Train GP Surrogate Model':
        #     simCenterUQCommand = '"{}" "{}/{}" "{}" {} {} {} {} 1> logFileSimUQ.txt 2>&1'.format(python,myScriptDir,surrogate,workdir_main,inputFile, workflowDriver, osType, runType)  # noqa: ERA001, E501
        # elif uq_data['uqType'] == 'Sensitivity Analysis':  # noqa: ERA001
        #     simCenterUQCommand = '"{}/{}" "{}" {} {} {} {} 1> logFileSimUQ.txt 2>&1'.format(myScriptDir,natafExe,workdir_main,inputFile, workflowDriver, osType, runType)  # noqa: ERA001, E501
        # elif uq_data['uqType'] == 'Forward Propagation':  # noqa: ERA001
        #     simCenterUQCommand = '"{}/{}" "{}" {} {} {} {} 1> logFileSimUQ.txt 2>&1'.format(myScriptDir,natafExe,workdir_main,inputFile, workflowDriver, osType, runType)  # noqa: ERA001, E501
        # # KZ: training calling runPLoM.py to launch the model training
        # elif uq_data['uqType'] == 'PLoM Model':  # noqa: ERA001
        #     simCenterUQCommand = '"{}" "{}" "{}" {} {} {} {}'.format(python, os.path.join(myScriptDir,plom).replace('\\','/'),workdir_main.replace('\\','/'),inputFile,workflowDriver,osType,runType)  # noqa: ERA001, E501
