    ...
    def refresh_status(self):
        ...
        if self.pre_task:
            if not self.pre_task.refresh_status():
                ...
                return self.status  # noqa: DOC201
