...
class Result_Time:  # noqa: D101
    ...
    def convertTimeSecondToDay(self, data, column, time_shift=0):  # noqa: ANN001, ANN201, D102, N802, PLR6301
        data.loc[:, column] = data.loc[:, column] - time_shift  # noqa: PLR6104
        data.loc[:, column] = data.loc[:, column] / 24 / 3600

    def convertTimeSecondToHour(self, data, column, time_shift=0):  # noqa: ANN001, ANN201, D102, N802, PLR6301
        data.loc[:, column] = data.loc[:, column] - time_shift  # noqa: PLR6104
        data.loc[:, column] = data.loc[:, column] / 3600  # noqa: PLR6104

    def averageOverDaysCrewTotalReport(self, crew_report):  # noqa: ANN001, ANN201, D102, N802, PLR6301
