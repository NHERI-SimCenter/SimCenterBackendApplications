        ...
        if 'Events' in available_apps:
            ...
            for event in events:
                if 'EventClassification' in event:
                    ...
                    # TODO: Fully implement HydroUQ's waterborne events into PBE  # noqa: FIX002, TD002, TD003
                    elif (
                        ...
                        if is_hydrouq_implemented:
                            ...
                            raise WorkFlowInputError(  # noqa: F405, TRY003, TRY301
                                'HydroUQ waterborne events are not implemented in PBE yet. Please use different workflow for now...'  # noqa: EM101, E501
                            )
                    else:
                        raise WorkFlowInputError(  # noqa: F405, TRY301
