...
baty = Topodata(datatype='celeris',path='./applications/createEVENT/Celeris/examples/CrescentCity',filename='bathy.txt')

# 2) Set Boundary conditions
bc = BoundaryConditions(celeris=True,path='./applications/createEVENT/Celeris/examples/CrescentCity',precision=precision)
