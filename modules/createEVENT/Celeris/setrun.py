...
baty = Topodata(datatype='celeris',path='./examples/CrescentCity',filename='bathy.txt')

# 2) Set Boundary conditions
bc = BoundaryConditions(celeris=True,path='./examples/CrescentCity',precision=precision)
...
# time.sleep(1)
# print("Warm start")
run = Evolve(solver = solver, maxsteps= 100000, saveimg=True)
