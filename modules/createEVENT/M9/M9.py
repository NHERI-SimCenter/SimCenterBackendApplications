...
modules_reqd = {'numpy','pandas','geopandas', 'shapely', 'requests', 'xarray', 'argparse'}
...
def M9(information):
    ...
    site_location = information['SiteLocation']
...
if __name__ == "__main__":
    ...
    print("Starting M9 Motion selection")

    information = { 'SiteLocation': True, 
    ...
    #input_args = sys.argv[1:]  # Exclude the script name
    ...
    Boundary = M9(information)
    print('Done M9 Downloads')
    exit()
