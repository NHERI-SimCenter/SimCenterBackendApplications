...
function(simcenter_add_executable)
    ...
    # Install rule for executable — destination is relative to CMAKE_INSTALL_PREFIX
    # so "cmake --install build --prefix ./applications" places each binary under
    # applications/<moduleName>/<executableName>
    get_current_module_dir(moduleDir)
    get_current_module_name(moduleName)
    install(TARGETS ${ARG_NAME} DESTINATION "${moduleName}")
